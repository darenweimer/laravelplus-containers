...
container  alpine  php    production   laravelplus/php:8.2.7-alpine3.18      ALPINE_VERSION=3.18  PHP_VERSION=82
container  alpine  php    development  laravelplus/php:8.2.7-alpine3.18-dev  ALPINE_VERSION=3.18  PHP_VERSION=82
...
container  ubuntu  php    production   laravelplus/php:8.2.7-ubuntu22.04      UBUNTU_VERSION=22.04  PHP_VERSION=8.2
container  ubuntu  php    development  laravelplus/php:8.2.7-ubuntu22.04-dev  UBUNTU_VERSION=22.04  PHP_VERSION=8.2
